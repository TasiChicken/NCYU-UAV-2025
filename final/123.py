    ...
    while not square_same(detected_squares, target_square):
        ...
        if key != -1:
            ...
            if detected_squares == [0,0,0,0,0,0,0,0,0]:
                ...
                fb += int(mss((0.25 - black_ratio) * 60, 10))
...
def see_multi(drone, markId, z_dist=50):
    frame_read = drone.get_frame_read()
...
def left_until_any_marker_detected(drone):
    frame_read = drone.get_frame_read()
...
def main():
    ...
    if detected_doll == "Kanahei":
        ...
        print("Move left!")
        drone.move("left", 20)
        trace_line(drone, [-22,0,0,0], [2,1,2,2,1,2,2,2,2], horizontal_trace=True, target_corner=0)
        print("0 corner")
        ...
        print("Move up!")
        drone.move("up", 20)
        trace_line(drone, [0,0,22,0], [0,0,0,1,1,2,2,2,2], horizontal_trace=False, target_corner=1)
        print("1 corner")
        ...
        print("Move left!")
        drone.move("left", 20)
        trace_line(drone, [-22,0,0,0], [0,2,2,0,1,2,0,1,2], horizontal_trace=True, target_corner=2)
        print("2 corner")
        ...
        print("Move down!")
        drone.move("down", 20)
        trace_line(drone, [0,0,-22,0], [2,2,2,1,1,2,0,0,0], horizontal_trace=False, target_corner=3)
        print("3 corner")
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, [-22,0,0,0],  [0,2,2,0,1,2,0,1,2], horizontal_trace=True, target_corner=4)
        print("4 corner")
        ...
        print("Move down!")
        drone.move("down", 20)
        trace_line(drone, [0,0,-22,0], [2,2,2,1,1,2,0,0,0], horizontal_trace=False, target_corner=5)
        print("5 corner")
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, [-22,0,0,0], [2,1,2,2,1,2,2,2,2], horizontal_trace=True, target_corner=2)
        ...
        print("Moving up!")
        drone.move("up", 20)
        trace_line(drone, [0,0,22,0], [0,0,0,1,1,2,2,2,2], horizontal_trace=False, target_corner=3)
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, (-22,0,0,0), [0,1,2,0,1,2,0,2,2], horizontal_trace=True, target_corner=4)
        ...
        print("Moving up!")
        drone.move("up", 20)
        trace_line(drone, [0,0,22,0], [0,0,0,1,1,2,2,2,2], horizontal_trace=False, target_corner=5)
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, (-22,0,0,0), [2,2,2,2,1,2,2,1,2], horizontal_trace=True, target_corner=6)
    ...
    while True:
        ...
        post_trace_till_marker(drone, frame, left_speed=-20)
