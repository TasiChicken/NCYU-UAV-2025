...
def main():
    ...
    if detected_doll == "Kanahei":
        ...
        #---
        print("Move left!")
        trace_line(drone, [-17,0,0,0], [2,1,2,2,1,2,2,2,2], horizontal_trace=True, target_corner=0)
        print("0 corner")
        ...
        print("Move up!")
        drone.move("up", 20)
        trace_line(drone, [0,0,17,0], [0,0,0,1,1,2,2,2,2], horizontal_trace=False, target_corner=1)
        print("1 corner")
        ...
        print("Move left!")
        drone.move("left", 20)
        trace_line(drone, [-17,0,0,0], [0,2,2,0,1,2,0,1,2], horizontal_trace=True, target_corner=2)
        print("2 corner")
        ...
        print("Move down!")
        drone.move("down", 20)
        trace_line(drone, [0,0,-17,0], [2,2,2,1,1,2,0,0,0], horizontal_trace=False, target_corner=3)
        print("3 corner")
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, [-17,0,0,0],  [0,2,2,0,1,2,0,1,2], horizontal_trace=True, target_corner=4)
        print("4 corner")

        # |
        #---
        print("Move down!")
        trace_line(drone, [0,0,-17,0], [2,2,2,1,1,2,0,0,0], horizontal_trace=False, target_corner=5)
        print("5 corner")
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, [-17,0,0,0], [2,1,2,2,1,2,2,2,2], horizontal_trace=True, target_corner=2)
        ...
        print("Moving up!")
        drone.move("up", 20)
        trace_line(drone, [0,0,17,0], [0,0,0,1,1,2,2,2,2], horizontal_trace=False, target_corner=3)
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, (-17,0,0,0), [0,1,2,0,1,2,0,2,2], horizontal_trace=True, target_corner=4)
        ...
        print("Moving up!")
        drone.move("up", 20)
        trace_line(drone, [0,0,17,0], [0,0,0,1,1,2,2,2,2], horizontal_trace=False, target_corner=5)
        ...
        print("Moving left!")
        drone.move("left", 20)
        trace_line(drone, (-17,0,0,0), [2,2,2,2,1,2,2,1,2], horizontal_trace=True, target_corner=6)
